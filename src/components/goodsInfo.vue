                                        ...
                                        <dd>
                                            <div class="stock-box">
                                                <div class="el-input-number el-input-number--small">
                                                    <span role="button" class="el-input-number__decrease " :class="{'is-disabled':buyNum==goodsinfo.stock_quantity}">
                                                        <i @click="buyNum==1?buyNum==1:buyNum--" class="el-icon-minus"></i>
                                                    </span>
                                                    <span role="button" class="el-input-number__increase">
                                                        <i @click="buyNum<goodsinfo.stock_quantity

?buyNum++:goodsinfo.stock_quantity" class="el-icon-plus"></i>
                                                    </span>
                            ...
                            <div class="tab-content" :style="{display:!isshowDesc?'block ':'none '}">
                                <div class="comment-box">
                                    <div id="commentForm" name="commentForm" class="form-box">
                                        ...
                                        <div class="conn-box">
                                            <div class="editor">
                                                <textarea v-model.trim="commentscontent" id="txtContent" name="txtContent" sucmsg=" " datatype="*10-1000" nullmsg="请填写评论内容！"></textarea>
                                                <span class="Validform_checktip"></span>
                                            </div>
                                            <div class="subcon">
                                                <input @click="submitConments" id="btnSubmit" name="submit" type="submit" value="提交评论" class="submit">
                                                <span class="Validform_checktip"></span>
                                            </div>
                                        </div>
                                    </div>
        ...
        <BackTop></BackTop>
        <img class="moveImg" style='display:none' :src="imglist[0].original_path" alt="">
    </div>
    ...
    submitConments() {
      ...
      this.axios
        ...
        .then(response => {
          ...
          // this.commentscontent=response.data.
        })
        .catch(error => {
          console.log(error);
        });
